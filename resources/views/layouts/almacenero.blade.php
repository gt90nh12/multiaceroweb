            ...
            <div class="container-fluid">
              ...
              <a href="index.html" class="topnav-logo">
                  <span class="topnav-logo-lg">
                      <img src="{{asset('assets/images/LOGO_KAPA.png')}}" alt="" height="50">
                  </span>
            ...
            <div class="wrapper">
                ...
                <div class="left-side-menu left-side-menu-detached">
                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-title side-nav-item">Administrador de Almacen</li>
                        ...
                        <!-- <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">            
                                <li class="side-nav-item">
                                    ...
                                    <ul class="side-nav-third-level" aria-expanded="false">
                                        <li>
                                            <a href="{{url('/registrar_vehiculo')}}">Registrar</a>
                                        </li>
                                        <li>
                                            <a href="{{url('/listar_vehiculo')}}">Listar</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('/entrega_pedidos')}}">Registrar</a> 
                                </li>
                                 <li>
                                    <a href="#">Lista</a>
                                </li>
