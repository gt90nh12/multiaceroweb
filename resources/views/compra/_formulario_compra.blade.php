            ...
            <div class="tab-content mb-0 b-0">
                ...
                <div class="tab-pane fade" id="second">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <!-- Inicia seleccion multiple de producto -->
                            ...
                            <!-- Finaliza seleeccionador multiple -->
                        </div>
                        <div class="col-md-2">
               ...
               <!--      <div class="row"> 
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label" for="descuento_compra">Descuento de compra</label>
                                <div class="col-md-6">
                                    <input type="number" id="descuento_compra" name="descuento_compra" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <select name="unidad_monetariaCP" class="form-control" data-toggle="select4" data-select4-id="1" tabindex="-1" aria-hidden="true">
                                        <option data-select4-id="4">Seleccionar Unidad de monetaria</option>
                                        <option value="AK" data-select2-id="15">Bolivianos</option>
                                        <option value="HI" data-select2-id="16">Dolares</option>
                                    </select>
                                </div>
