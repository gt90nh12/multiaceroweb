                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select id="seleccionAlmacen" class="form-control">
                                        @if(!empty($almacenes))
                                        <option data-select2-id="3" hidden>Seleccione Almacen</option>
